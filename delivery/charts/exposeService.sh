export POD_NAME=$(kubectl get pods --namespace hello-helm -l "app.kubernetes.io/name=podtatoserver,app.kubernetes.io/instance=kubecon-release" -o jsonpath="{.items[0].metadata.name}")
